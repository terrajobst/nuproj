...
By specifying `VersionConstraint` metadata, you can set version range of the
dependency package. `*` token represents version of package generated by NuProj
project.

```xml
<ItemGroup>
  <!-- Generates vaersion="[1.0.0, 2.0)" constraint. /> -->
  <ProjectReference Include="..\Dependency\Dependency.nuproj">
    <VersionConstraint>[*,2.0)</VersionConstraint>
  </ProjectReference>
</ItemGroup>
```
